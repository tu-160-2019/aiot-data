...
package net.srt.flink.gateway.kubernetes;
...
import net.srt.flink.gateway.result.KubernetesResult;
...
public class KubernetesApplicationGateway extends KubernetesGateway {
	...
	public GatewayResult submitJar() {
		...
		try {
			...
			int counts = ProjectSystemConfiguration.getByProjectId(process.getProjectId()).getJobIdWait();
