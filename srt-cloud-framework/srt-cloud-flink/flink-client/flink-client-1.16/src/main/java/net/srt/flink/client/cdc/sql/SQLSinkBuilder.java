...
package net.srt.flink.client.cdc.sql;

import net.srt.flink.client.base.executor.CustomTableEnvironment;
import net.srt.flink.client.base.model.FlinkCDCConfig;
import net.srt.flink.client.base.utils.FlinkBaseUtil;
import net.srt.flink.client.cdc.AbstractSinkBuilder;
import net.srt.flink.client.cdc.CDCBuilder;
import net.srt.flink.client.cdc.SinkBuilder;
    ...
    public DataStreamSource build(
        ...
        if (Asserts.isNotNullCollection(schemaList)) {
            ...
            SingleOutputStreamOperator<Map> processOperator = mapOperator.process(new ProcessFunction<Map, Map>() {
                @Override
                public void processElement(Map map, Context ctx, Collector<Map> out) throws Exception {
