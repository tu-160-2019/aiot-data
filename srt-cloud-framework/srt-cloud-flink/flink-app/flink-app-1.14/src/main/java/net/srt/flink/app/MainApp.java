...
public class MainApp {
    ...
    public static void main(String[] args) {
        ...
        Submiter.submit(Integer.valueOf(id), dbConfig, params.get(FlinkParamConstant.FLINKY_ADDR));
    }
}
