...
package net.srt.flink.alert.email;

import com.sun.mail.smtp.SMTPProvider;
import net.srt.flink.alert.base.AlertException;
import net.srt.flink.alert.base.AlertResult;
import net.srt.flink.alert.base.ShowType;
import net.srt.flink.alert.email.template.AlertTemplate;
import net.srt.flink.alert.email.template.DefaultHTMLTemplate;
