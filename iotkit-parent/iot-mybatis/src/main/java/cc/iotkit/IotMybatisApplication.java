...
@EnableWebMvc
@EnableScheduling
public class IotMybatisApplication implements SpringBootstrap {

    public static void main(String[] args) {

        SpringMainBootstrap.launch(IotMybatisApplication.class, args);
        log.info("server start success!");
    }

    @Override
    public void run(String[] args) {
        SpringApplication.run(IotMybatisApplication.class, args);
    }
